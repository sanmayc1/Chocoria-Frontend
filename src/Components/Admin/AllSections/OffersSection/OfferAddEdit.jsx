    ...
    <>
      ...
      <div className="flex flex-col items-center gap-3">
        <div className="flex gap-3 w-full">
          ...
          >
            Offer Title
            <SingleInputField placeholder={"Offer Name"} noLimitWidth value={offerData.offerTitle} handleChange={handleChange} name={"offerTitle"} />
          </label>
          <label
        ...
        <div className="w-full flex gap-3">
          ...
          >
            Offer Expiry Date
           <input type="Date" className="w-full p-3 bg-gray-200 rounded-lg " min={new Date().toISOString().split('T')[0]} value={offerData.expiryDate} onChange={handleChange} name={"expiryDate"} />
          </label>
        </div>
        <label
